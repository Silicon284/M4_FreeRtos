...
void MX_TIM4_Init(void)
{
  ...
  GPIO_InitStruct_TM4_1.Mode      = GPIO_MODE_AF_PP;
...
void SM_Ultrasonic_Trigger_Pulse(void) {
  /* Start the PWM signal on TIM3 Channel 3*/
  HAL_TIM_PWM_Start(&htim3, TIM_CHANNEL_3);
}

void SM_Ultrasonic_Calculate_distance(void) {
